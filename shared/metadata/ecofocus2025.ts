...
const sharedMetrics: MetricMetadata[] = [
  {
    id: "column_percent",
    label: "Column %",
    valueFormat: "percent",
...
const sharedWeights: WeightMetadata[] = [
  {
    id: "weightvar",
...
const sharedQuestions: QuestionMetadata[] = [
  {
  ...
  },
  {
    ...
    allowedBreakBys: ["GENERATION", "REGION", "SUMMARY"],
    options: [
...
const sharedDimensions: DimensionMetadata[] = [
  {
    id: "SUMMARY",
    label: "Summary",
    role: "banner",
...
export const ecofocus2024Metadata: DatasetMetadata = {
  id: "ecofocus_2024",
  label: "EcoFocus 2024",
  wave: "2024",
  description: "Prior-wave mock survey metadata for EcoFocus Explore trend comparisons.",
  defaultQuestion: "Q15_TOP2_BRAND_PRIORITIES",
  defaultBreakBy: "SUMMARY",
  defaultWeight: "weightvar",
  minBaseWarning: 100,
...
export function getComparisonDatasetOptions(currentDatasetId: DatasetId) {
  return datasets.filter((dataset) => dataset.id !== currentDatasetId);
}
